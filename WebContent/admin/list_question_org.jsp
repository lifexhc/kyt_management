...
<table width="100%" align="center" border="1" cellpadding="1" cellspacing="1" rules="all">
	<tr align="center" bgcolor="#D5D5D5">
		...
		<td width="10%" align="center"><strong>问题描述</strong></td>
		...
		if(question_num_patient>0){
			...
			for(int i=question_num_patient;i>=1;i++){	
				...
				%>
				 <tr align="center" >		
						...
						<td width="10%" align="center"><div style="color:red;">未答复</div></td>
						<td width="10%"></td>					
